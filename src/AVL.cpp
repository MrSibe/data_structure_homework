  ...
  失去平衡,则作平衡旋转处理,布尔变量taller反映b长高与否*/
{
    ...
    else
    {
        ...
        {
            if ((InsertAVL(b->lchild,e, sec, name, lei, mutimedia, size, pos, taller))==0) //未插入
                return 0;
        ...
        {
            if ((InsertAVL(b->rchild,e, sec, name, lei, mutimedia, size, pos, taller))==0) //未插入
                return 0;
...
//由DeleteAVL()调用,用于处理被删结点左右子树均不空的情况
{
    if (r->rchild==NULL)
    {
        ...
        strcpy(q->pos, r->pos);
        q->size=r->size;
        strcpy(q->mutimedia, r->mutimedia);
        q=r;
        r=r->lchild;
        free(q);
        taller=1;
...
//     for(int i = 1; i <= 9; i++)
//     {
//         InsertAVL(b, data[i-1], taller);
//         printf("   第%d步,插入%d元素:", i, data[i-1]);
//         DispBSTree(b);
//         printf("\n");
//     }
//     printf("   AVL:");
...
//     printf("\n 删除结点:\n");
//     printf("   删除结点%d:", 11);
//     DeleteAVL(b, 11, taller);
//     printf("   AVL:");
//     DispBSTree(b);
//     printf("\n   删除结点%d:", 9);
//     DeleteAVL(b, 9, taller);
//     printf("   AVL:");
//     DispBSTree(b);
//     printf("\n   删除结点%d:", 15);
//     DeleteAVL(b, 15, taller);
//     printf("   AVL:");
//     DispBSTree(b);
//     return 0;
// }
